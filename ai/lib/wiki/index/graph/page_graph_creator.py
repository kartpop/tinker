...
# - in case the page or section already existed, capture page_uuid and section_uuid from the result of the cypher queries
# and subsequently use the existing uuids 
