...
## v2: component's run function now returns a list of haystack Documents enriched with hierarchy metadata instead of plain list of strings

@component
class WikiContextCreatorV2:
    ...
    def run(self, hierarchy_paths: List[str], chunks_hierarchy: dict):
        ...
        for path in path_list:
            ...
            # page_sub_hierarchy_metadata = {"title": page_title}
